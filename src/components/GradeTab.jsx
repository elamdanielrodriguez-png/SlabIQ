            ...
            <div style={{ display: "flex", gap: 10, marginBottom: 28, position: "relative" }}>
              {[
                ...
                <div key={company} className={`hero-float-${idx}`} style={{
                  ...
                  <div style={{ color: "#c9a84c", fontSize: 48, fontWeight: 800, lineHeight: 1, letterSpacing: "-2px", textShadow: "0 0 40px rgba(201,168,76,0.85), 0 0 80px rgba(201,168,76,0.3)" }}>{grade}</div>
                  <div style={{ color: "rgba(255,255,255,0.3)", fontSize: 9, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginTop: 8 }}>{sub}</div>
                </div>
              ))}
            </div>
      ...
      {images.length > 0 && !result && isLoggedIn && planName !== 'free' && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
          {[
            ...
            { model: "claude-opus-4-8",   label: "IQ Ultra", cost: "1 token / grade" },

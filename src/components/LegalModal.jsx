  ...
  return (
    <>
      <Section title="The Service">
        <p style={{ margin: "0 0 8px" }}>CardGradeOrNot provides AI-assisted sports card grading estimates. Results are generated by an AI model and are <strong style={{ color: "rgba(255,255,255,0.8)" }}>not official PSA, BGS, or SGC grades</strong>. They are estimates to help you decide whether to submit for professional grading.</p>
